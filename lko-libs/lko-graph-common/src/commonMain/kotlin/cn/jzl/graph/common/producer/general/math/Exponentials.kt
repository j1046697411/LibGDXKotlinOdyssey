...
class ExponentialBase2 : SingleInputGeneralPipelineNodeProducer("ExponentialBase2", "ExponentialBase2", "Exponentials/ExponentialBase2") {
...
class Exponential : SingleInputGeneralPipelineNodeProducer("Exponential", "Exponential", "Exponentials/Exponential") {
    override val input = createNodeInput("input", "input")
    override val output = createNodeOutput("output", "Result")
    override fun executeFunction(value: Float): Float = exp(value)
}

class InverseSqrt : SingleInputGeneralPipelineNodeProducer("InverseSqrt", "InverseSqrt", "Exponentials/InverseSqrt") {
    override val input = createNodeInput("input", "input")
    override val output = createNodeOutput("output", "Result")
    override fun executeFunction(value: Float): Float = 1f / sqrt(value)
}

class LogarithmBase2 : SingleInputGeneralPipelineNodeProducer("LogarithmBase2", "LogarithmBase2", "Exponentials/LogarithmBase2") {
    override val input = createNodeInput("input", "input")
    override val output = createNodeOutput("output", "Result")
    override fun executeFunction(value: Float): Float = log2(value)
}

class NaturalLogarithm : SingleInputGeneralPipelineNodeProducer("NaturalLogarithm", "NaturalLogarithm", "Exponentials/NaturalLogarithm") {
    override val input = createNodeInput("input", "input")
    override val output = createNodeOutput("output", "Result")
    override fun executeFunction(value: Float): Float = ln(value)
}

class Power : DualInputGeneralPipelineNodeProducer("Power", "Power", "Exponentials/Power") {
...
class Square : SingleInputGeneralPipelineNodeProducer("Square", "Square", "Exponentials/Square") {
    override val input = createNodeInput("input", "input")
    override val output = createNodeOutput("output", "Result")
