 ...
 */
class ByteFastList(capacity: Int = 7, val order: Boolean = true) : AbstractMutableFastList<Byte>(), ByteMutableFastList {
    ...
    override fun ensureCapacity(capacity: Int, element: Byte) {
    ...
    override fun fill(element: Byte, startIndex: Int, endIndex: Int) {
    ...
    override fun insertLast(element: Byte) {
        ensure(1)
        data[size++] = element
    }

    override fun insertLast(element1: Byte, element2: Byte) {
        ensure(2)
        data[size++] = element1
        data[size++] = element2
    }

    override fun insertLast(element1: Byte, element2: Byte, element3: Byte) {
        ensure(3)
        data[size++] = element1
        data[size++] = element2
        data[size++] = element3
    ...
    override fun insertLast(element1: Byte, element2: Byte, element3: Byte, element4: Byte) {
        ensure(4)
        data[size++] = element1
        data[size++] = element2
        data[size++] = element3
    ...
    override fun insertLast(element1: Byte, element2: Byte, element3: Byte, element4: Byte, element5: Byte) {
        ensure(5)
        data[size++] = element1
        data[size++] = element2
        data[size++] = element3
    ...
    override fun insertLast(element1: Byte, element2: Byte, element3: Byte, element4: Byte, element5: Byte, element6: Byte) {
        ensure(6)
        data[size++] = element1
        data[size++] = element2
        data[size++] = element3
    ...
    override fun insertLastAll(elements: Iterable<Byte>) {
        ...
        when (elements) {
            ...
            is Collection<Byte> -> {
                ...
                val bytes = elements.toList()
                if (bytes.isNotEmpty()) {
                    ensure(bytes.size)
                    bytes.forEachIndexed { i, e -> data[size + i] = e }
                    size += bytes.size
                }
            }
        }
    ...
    override fun insertLastAll(elements: ByteArray) {
    ...
    override fun insert(index: Int, element: Byte) {
        ensure(1)
        data.copyInto(data, index + 1, index, size)
        data[index] = element
        size++
    ...
    override fun insert(index: Int, element1: Byte, element2: Byte) {
        ensure(2)
    ...
    override fun insert(index: Int, element1: Byte, element2: Byte, element3: Byte) {
        ensure(3)
    ...
    override fun insert(index: Int, element1: Byte, element2: Byte, element3: Byte, element4: Byte) {
        ensure(4)
    ...
    override fun insert(index: Int, element1: Byte, element2: Byte, element3: Byte, element4: Byte, element5: Byte) {
        ensure(5)
    ...
    override fun insert(index: Int, element1: Byte, element2: Byte, element3: Byte, element4: Byte, element5: Byte, element6: Byte) {
        ensure(6)
    ...
    override fun insertAll(index: Int, elements: Iterable<Byte>) {
        if (elements is Collection<*> && elements.isEmpty()) return
        when (elements) {
            is ByteFastList -> {
                ensure(elements.size)
            ...
            is Collection<Byte> -> {
                ...
                if (bytes.isNotEmpty()) {
                    ...
                    data.copyInto(data, index + bytes.size, index, size)
                    bytes.forEachIndexed { i, e -> data[index + i] = e }
                    size += bytes.size
                }
            }
        }
    ...
    override fun insertAll(index: Int, elements: ByteArray) {
        if (elements.isEmpty()) return
        ensure(elements.size)
        data.copyInto(data, index + elements.size, index, size)
